      ...
      <div class="sponsor-container">
        <div class="card-container individual-sponsor">
          <div class="card">
            ...
            <p
              class="paragraph"
            >SITCON 學生計算機年會為學生自發組成籌辦的研討會，秉持著以學生為主軸的核心價值，提供一個經驗交流與資訊技術實務分享的平台，進而達到「學以致用、教學相長」的目標。</p>
            <p class="paragraph">
            ...
            >
              <div class="img-container">
                <a :href="`${sponsor.url}`" target="_blank" rel="noopener">
                  <img
                    :alt="sponsor.name"
                    :src="`https://sitcon.org/2020/img/sponsors/${sponsor.image}`"
                  />
                </a>
              </div>
              <div class="text-container">
                <h3>{{ sponsor.name }}</h3>
                <p v-if="sponsor.description" v-html="markdownParser(sponsor.description)"></p>
              </div>
            </div>
          </div>
        </div>
